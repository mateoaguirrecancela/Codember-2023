...
int main(){
    ...
    tamaño=trocearCadena(mensaje, trozos);  //Dividir el mensaje en un array, en cada posicion hay una palabra

    for (int i = 0; i < tamaño; i++){       //Buscar cada palabra del mensaje
